      ...
      <div className="container mx-auto px-10 lg:py-7 py-28 relative  lg:min-h-[90vh] md:min-h-[50vh] pt-14 ">
        ...
        <div className="flex items-center md:py-12">
          <div className="md:w-1/2 w-full md:text-left text-center">
            <div
              className="flex flex-col md:max-w-3xl w-full "
              data-aos="fade-right"
              data-aos-duration="2000"
            >
              <h1 className="font-nunito xl:text-6xl md:text-4xl text-2xl font-extrabold text-[#172048] leading-tight mb-6">
                Make Your Life Healthier with{" "}
                <span className="gradient-text">FitLifestyle</span>
              </h1>
              <p className="xl:text-2xl md:text-xl text-base text-[#9D9D9D]">
              ...
              <div className="my-16">
                <Link
                  to={"/dashboard"}
                  className="bg-[#4A72FF] md:py-3 md:px-14 py-2 px-10 text-white rounded-3xl font-bold xl:text-2xl lg:text-xl md:text-lg text-base tracking-wide hover:opacity-90"
                >
                  Activity
                </Link>
              </div>
              <div className="lg:py-5 lg:px-10 py-3 px-7 rounded-2xl bg-[#E8ECF9] flex flex-col w-fit space-y-4 mx-auto md:mx-0">
